...
<%@tag import="org.slf4j.Logger"%>
<%@tag import="com.boilerplate.entity.User"%>
<%@tag import="com.boilerplate.util.Authorities"%>
<%@ attribute name="header1" required="true" type="java.lang.String"%>
<jsp:useBean id="AuthUtil" class="com.boilerplate.util.AuthenticationUtil" />
