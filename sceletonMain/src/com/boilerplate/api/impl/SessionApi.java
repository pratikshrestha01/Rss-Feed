...
import com.boilerplate.repositories.UserSessionRepository;
...
public class SessionApi implements ISessionApi, InitializingBean {
	...
	public void registerNewSession(String sessionId, UserDetailsWrapper principal) {
		...
		User myUser=userRepository.findByUsername(principal.getUsername());
		if(myUser==null){
			myUser=userRepository.findByUserMobile(principal.getUsername());
		}
